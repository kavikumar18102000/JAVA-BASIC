...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  3) Run-time errors (Exceptions) : Java sometimes may encounter an error while the program is running. These are also called Exceptions !. These are encountered due to circumstances
  									like bad input or resource constraints.
  									
  									example : user supplies 's'+8 which adds two numbers, but user should provide an integer number. So it is an exception.
  									
  			syntax and logical errors are encountered by the programmer but where as run-time errors are encountered by the users.
